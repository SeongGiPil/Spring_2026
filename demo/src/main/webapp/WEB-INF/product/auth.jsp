<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <body>
        <div id="app">
            ...
            <input placeholder="정보입력" v-model="info">
            ...
            methods: {
                ...
                fnAuth: function () {
                    IMP.certification(
                        {
                            // param
                            channelKey: "channel-key-a0c6c97c-82f6-4093-971a-2a40417df817",
                            merchant_uid: "ORD20180131-123123123", // 주문 번호
